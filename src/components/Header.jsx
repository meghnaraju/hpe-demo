...
class Header extends Component{
    render(){
        return(
            ...
            <Grid.Column width={5}>
                <Anchor target="https://www.hpe.com/us/en/solutions/smb/jrit-promotions.html" value="See new deals" imgSrc={MenuImage}/>
            </Grid.Column>
            <Grid.Column width={3}>
               <Dropdown placeholder="Select a category" options={header.searchResults} search={true}/>   
            </Grid.Column>
            <Grid.Column width={2}>
